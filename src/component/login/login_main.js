...
const Kakaologin = () => {
    ...
    const KAKAO_URL = "https://kauth.kakao.com/oauth/authorize?client_id=debb9ef2afa1c404a8b14a3788d996a5&redirect_uri=http://localhost:3000/oauth&response_type=code"
    return (
        <>
